        ...
        <form method="POST" action="{{ route('admin.tickets.update', $ticket) }}">
            ...
            <div class="form-group">
                ...
                <input id="subject" class="form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}"
                       name="subject" value="{{ old('subject', $ticket->subject) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea id="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}"
                          name="content" rows="10" required>{{ old('content', $ticket->content) }}</textarea>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary">Сохранить измнения</button>
            </div>
        </form>
    </div>
@endsection
